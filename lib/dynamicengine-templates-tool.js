...
export default {
  ...
  createTemplateData(id,repoUrl,prjName){
    return {
        "id" : id,
        "repoUrl": repoUrl,
        "prjName" : prjName
  ...
  setupButtons(){
    this.setupButton(this.createTemplateData("1","https://gitlab.vipera.com/dynamic-engine-team/de_template_angularjsionicsimple.git","de_template_angularjsionicsimple"));
    this.setupButton(this.createTemplateData("2","https://gitlab.vipera.com/dynamic-engine-team/de_template_cardcontrol_angularjs.git","de_template_cardControlIonic"));
    this.setupButton(this.createTemplateData("3","https://gitlab.vipera.com/dynamic-engine-team/de_template_reactjs_simple.git","de_template_reactjs_simple"));
    this.setupButton(this.createTemplateData("4","https://gitlab.vipera.com/dynamic-engine-team/de_template_multiview_kitchensink.git","de_template_multiview_kitchensink"));
  },
  ...
  setupButton(templateData){
    var that = this;
    document.getElementById('detemplates-btn-download-' + templateData.id).addEventListener("click", function(event){
      that.downloadTemplate( {
          "id" : templateData.id,
          "repoUrl": templateData.repoUrl,
          "prjName" : templateData.prjName
        });
    });
  },
